        ...
        <form action="product_list.php" method="post">
            <table class="datalist fixwidth">
                <tbody>
                    ...
                    <?php foreach ($product->getAllProduct() as $v):?>
                        <tr>
                            <td width="80"><input name="proID[]" value="<?= $v['proID']?>" class="checkbox" type="checkbox"></td>
                            <td width="200"><strong><?= $v['proName']?></strong></td>
                            <td width="100"><img src="<?= $v['proImage']?>"></td>
                            <td width="100"><?= $v['proAdd']?></td>
                            <td width="150"><?= date('Y-m-d H:i:s',$v['proTime'])?></td>
                            <td width="100"><a href="product_modify.php?proID=<?= $v['proID']?>">编辑</a></td>
                        </tr>
                    <?php endforeach;?>
                    <tr class="nobg">
